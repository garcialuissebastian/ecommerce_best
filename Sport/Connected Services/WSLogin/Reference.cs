...
namespace Sport.WSLogin {
    ...
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(Sport.WSLogin.LoginFault), Action="", Name="fault")]
        Sport.WSLogin.loginCmsResponse loginCms(Sport.WSLogin.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<Sport.WSLogin.loginCmsResponse> loginCmsAsync(Sport.WSLogin.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : Sport.WSLogin.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<Sport.WSLogin.LoginCMS>, Sport.WSLogin.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        Sport.WSLogin.loginCmsResponse Sport.WSLogin.LoginCMS.loginCms(Sport.WSLogin.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            Sport.WSLogin.loginCmsRequest inValue = new Sport.WSLogin.loginCmsRequest();
            inValue.in0 = in0;
            Sport.WSLogin.loginCmsResponse retVal = ((Sport.WSLogin.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<Sport.WSLogin.loginCmsResponse> Sport.WSLogin.LoginCMS.loginCmsAsync(Sport.WSLogin.loginCmsRequest request) {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<Sport.WSLogin.loginCmsResponse> loginCmsAsync(string in0) {
            Sport.WSLogin.loginCmsRequest inValue = new Sport.WSLogin.loginCmsRequest();
            inValue.in0 = in0;
            return ((Sport.WSLogin.LoginCMS)(this)).loginCmsAsync(inValue);
        }
    }
}
